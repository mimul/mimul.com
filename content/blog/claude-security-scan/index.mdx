---
title: Claude로 만드는 멀티 레이어 보안 진단 스킬 claude-security-scan
description: SAST·DAST를 아우르는 보안 진단 스킬 두 가지를 오픈소스로 공개합니다. Semgrep·Trivy로 정적 분석, OWASP ZAP·Nuclei로 런타임 검증을 수행하며 Claude가 교차 분석으로 False Positive를 줄입니다.
author: Mimul
date: "2026-03-18T19:12:45.000Z"
lastModificationTime: "2026-05-06T09:00:00.000Z"
image: "./security2.png"
tags:
  - security
  - threat-modeling
  ...
  - zero-trust
---
Claude와 오픈소스 보안 도구를 결합해 코드 정적 분석부터 런타임 검증까지 커버하는 보안 진단 스킬 두 가지를 만들어 공개했다.
