...
| 평가축 | 설명 |
|--------|------|
| **목적 적합성** | 결정의 출발점인 진짜 가치와 목적을 최우선으로 삼는다 |
| **제약 적합성** | 기능/비기능 요구사항을 체계적으로 고려한다 |
| **실현 가능성** | 기술적·경제적·운영적 실현 가능성을 확인한다 |
| **품질 영향** | 유지보수성, 신뢰성, 보안, 성능 등 소프트웨어 품질에 미치는 영향을 평가한다 |
| **시간 효과** | 단기 vs 장기 관점에서의 비용·가치 트레이드오프를 고려한다 (Technical Debt) |
| **위험 및 불확실성** | 불확실성에 대한 명시적 위험 평가를 수행한다 |
| **무결성** | 아키텍처 결정의 일관성과 장기적 무결성을 유지한다 (ADR) |
| **합의 가능성** | 좋은 결정이라도 실행 의지와 합의가 없으면 실패한다 |
