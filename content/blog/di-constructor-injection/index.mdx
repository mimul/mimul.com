...
description: Spring에서 의존성 주입이 필요한 이유와 Constructor Injection이 권장되는 이유에 대해 상세히 소개함.
author: Mimul
...
---
재사용성, 테스트 용이, 코드 단순화, 결합도를 낮추어 확장성을 좋게하는 등의 장점이 있어서 DI를 언어별로 많이 사용하고 있는데 여기에서는 Spring에서 DI에 대해 정리해봅니다.
