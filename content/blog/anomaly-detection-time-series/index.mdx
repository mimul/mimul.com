...
lastModificationTime: "2025-01-16T22:09:31.000Z"
...
1편의 SVM에서 시작해 이 편의 그래프 기반·트리 기반·재구성 오차 기반까지, 1~4편이 다룬 기법을 논문의 분류체계 위에 모두 놓으면 아래와 같은 지도가 완성된다.

![1~4편이 완성한 이상탐지 분류체계 전체 지도](./taxonomy-position.svg)
