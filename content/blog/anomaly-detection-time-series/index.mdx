...
lastModificationTime: "2025-01-29T09:00:00.000Z"
...
이런 예측 오차 기반 접근은 실제 모니터링 제품에도 쓰인다. SolarWinds의 Database Performance Monitor는 Holt-Winters 예측으로 쿼리 지표의 이상을 탐지하는 기능을 제공하며, 계절성을 반영해 오탐을 줄인다. HTM을 개발한 Numenta는 이를 상용화한 Grok을 AWS Marketplace에 출시해, EC2·RDS 같은 AWS 서비스 지표를 실시간으로 학습하고 이상을 탐지하게 했다.
