...
이 투자 흐름은 자본이 어느 층으로 향하는지 보여줄 뿐, 개별 기업이 그 층을 실제 해자로 바꾸는 과정까지 보여주지는 않는다. 기존 기업이 AI를 나중에 들여와 워크플로우를 다시 짜는 이야기는 제3부에서 다룬다. 여기서 보는 기업들은 그와 달리 처음부터 AI와 보완 자산을 한 몸으로 설계해 태어났다.
