...
코드 리뷰 자동화 부분에 One-Way Door/Two-Way Door 용어는 [Jeff Bezos 의 2015 주주에게 편지 에 표시된 의사 결정 프레임](https://s2.q4cdn.com/299287126/files/doc_financials/annual/2015-Letter-to-Shareholders.PDF)에서 따왔다. 아래 "셀프(자동) 병합 가이드라인"의 내용을 보면 알겠지만, One-Way Door는 돌아갈 수 없는 결정을 말하고 이번 적용한 PR이 문제가 되어 롤백이 불가능한 경우를 뜻한다. 그리고 Two-Way Door는 돌아갈 수 있는 결정을 뜻하는데, PR이 문제가 되어도 롤백이 가능해 원복을 할 수 있다는 의미이다. 참고로 아래는 One-Way Door/Two-Way Door 판정의 기준을 나타낸다.
