  ...
  `);
    ...
    createPage({
      ...
      context: {
        ...
        permalink: `https://www.mimul.com${article.slug}`,
      },
    });
  });
  ...
  `);
      ...
      createPage({
        ...
        context: {
          ...
          permalink: `https://www.mimul.com${snippet.slug}`,
        },
      });
    });
      ...
      if (topic.totalStories > 0) {
        ...
        createPage({
          ...
          context: {
            ...
            topics,
            permalink: `https://www.mimul.com${topicStoriesPath}`,
          },
        });
      }
      ...
      if (topic.totalVideos > 0) {
        ...
        createPage({
          ...
          context: {
            ...
            topics,
            permalink: `https://www.mimul.com${topicVideosPath}`,
          },
        });
      }
      ...
      if (topic.totalServices > 0) {
        ...
        createPage({
          ...
          context: {
            ...
            tools: relatedTools,
            topics,
            permalink: `https://www.mimul.com${topicToolsPath}`,
          },
        });
      }
