...
export default function Hero() {
  ...
  return (
    <div className="hero-wrapper h-card">
      <section className="hero position-relative bgcolor-25">
        ...
        <div className="hero-body padrl-15">
            ...
            <div className="columns is-vcentered">
              <div className="column is-5 landing-caption">
                ...
                <p>
                  <Link
                    to="/about/"
                    className="button k-button k-primary raised has-gradient is-fat is-bold zindex-100"
                  >
              ...
              <div className="column is-7">
                <figure className="image">
                  <a href="https://www.mimul.com" className="u-url u-uid">
