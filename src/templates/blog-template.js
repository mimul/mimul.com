...
function BlogPage({ pageContext, data }) {
  ...
  const subTitle = `This section is a blog where I organize my experiences, research, prototypes I developed, and books and papers I read.`;
  ...
  return (
    <Layout>
      ...
      <PageHero
        title={`All Articles`}
        subtitle={subTitle}
        subscribeUrl={`https://www.mimul.com/blog/rss.xml`}
      />
