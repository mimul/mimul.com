...
const config = {
  siteMetadata: {
    title: "Mimul Tech blog",
    description:
      "기술 토픽에 관련된 개인적인 생각을 정리하고, 외국 기술 아티클, 논문을 번역해 공유합니다.",
    siteUrl,
    author: {
      name: "Mimul",
    ...
    },
    {
      ...
      options: {
        ...
        setup: ({
          ...
          siteMetadataModified.image_url = `${siteMetadata.siteUrl}/img/favicon-32x32.png`;
